...
const copySources = {
  ...
  closeBundle() {
    ...
    for (const name of ["direct-transport.js", "direct-react-vendor.jsx", "command-palette-direct.jsx", "command-palette-direct.css", "persistent-ui.js", "persistent-ui.css", "split-pane-direct.jsx", "split-pane.css", "object-inspector.jsx", "object-inspector.css"])
...
const entries = {
  ...
  inspector: { source: "src/object-inspector.jsx", name: "ShinyCapabilitiesObjectInspector", file: "object-inspector.js" }
};
